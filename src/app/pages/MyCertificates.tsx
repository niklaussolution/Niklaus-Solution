  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (certData.length === 0) {
        ...
        // If DOB is provided, filter by DOB match
        if (dob) {
          const filteredCerts = certData.filter(
            (cert) => cert.dateOfBirth === dob
          );
          if (filteredCerts.length === 0) {
            setError('No certificates found matching the provided date of birth');
            setCertificates([]);
          } else {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Leave empty to see all certificates, or enter DOB to find a specific certificate
                </p>
              </div>
            </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-md p-6">
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Optionally enter your date of birth for additional verification</span>
            </li>
            <li className="flex items-start gap-3">
