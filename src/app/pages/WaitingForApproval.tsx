    ...
    const unsubscribe = onSnapshot(
      ...
      (docSnapshot) => {
        if (!docSnapshot.exists()) {
          // Check if we were previously approved before assuming it's missing/rejected
          ...
          // If the doc doesn't exist yet, it's likely just syncing. Stay in waiting.
          console.log('Login request document not found yet, waiting...');
          setStatus('waiting');
          setMessage('Initializing your request...');
          return;
        }
