...
export function WorkshopsSection() {
  ...
  const handlePaymentSuccess = async () => {
    ...
    try {
      ...
      // Send registration details to team via nodemailer API (Vercel serverless function)
      try {
        const payload = {
          ...registrationData,
          notes: 'Registration notification',
        };
        ...
        console.log('Notification email response:', response.status, result);
      } catch (emailError) {
